<template>
  <q-page padding>
    <h3>
    <!-- <pre>{{nro_documento}}-{{paterno}}-{{materno}}-{{nombres}}- {{fecha}}-{{solicitudes_id}}-{{solicitantes_id}}</pre> -->
  </h3>
...
import VerSolicitudes from './verSolicitudes.vue'
...
export default {
    setup() {
        ...
        const solicitantes_id = ref(null);
        ...
        const reset = () => {
            ...
            nombres.value = null;
            fecha.value = null;
            solicitudes_id.value = null;
            solicitantes_id.value = null;
        };
        return {
            listaTipoDoc,
            nro_documento,
    ...
    methods: {
        ...
        async enviarDatos() {
            const data = {
                ...
                fecha: this.fecha,
                solicitudes_id: parseInt(this.solicitudes_id.id),
                solicitantes_id: parseInt(this.solicitantes_id.id)
            };
            console.log(data);
            try {
